...
class UserTest {
    ...
    void testLoginValidation() {
        User user = new User("hello@mail.ru", "", "Mary Ivanova",
                LocalDate.of(2000, 8, 5));
    ...
    void testBirthdayValidation() {
        User user = new User("hello@mail.ru", "hello", "Mary Ivanova",
                LocalDate.of(2200, 8, 5));
